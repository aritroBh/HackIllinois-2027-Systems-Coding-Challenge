...
(function () {
  ...
  // `v68`: standing-panel sprite contained in its box (max-width:100%, height:auto) so
  //        4×/5× heads no longer cross the card edge or cover the facts — styles.css moves.
  const VERSION = 'v68';
